...
public class Quiz07 {
    public static void main(String[] args) {
        Student__[] stu = new Student__[3];
        stu[0] = new Student__("홍길동", 15, 171, 80);
        stu[1] = new Student__("한사람", 13, 183, 70);
        stu[2] = new Student__("임걱정", 16, 175, 65);
...
class Student__ {
    ...
    public Student__(String name, int age, int height, int weight) {
        this.name = name;
        this.age = age;
        this.height = height;
        this.weight = weight;
